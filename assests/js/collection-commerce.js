(function () {
  ...
  function renderProduct(product) {
    ...
    var action = available && !product.requiresConfirmation
      ? '<button class="work__acquire" type="button" data-catalogue-add="' + esc(product.id) + '"><span>Add to cart</span><svg width="40" height="8" viewBox="0 0 40 8" fill="none" aria-hidden="true"><path d="M0 4H38M38 4L34 1M38 4L34 7" stroke="currentColor" stroke-width="1"/></svg></button>'
